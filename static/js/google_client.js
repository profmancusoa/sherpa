...
*/
		...
		_.x = function (a, b) {
			try {
				_.Ja('debug') && window.console && window.console.log && window.console.log(_.Ka(b) + a);
			} catch (c) {}
		};
		_.y = function (a, b) {
			try {
				_.Ja('warn') && window.console && window.console.warn && window.console.warn(_.Ka(b) + a);
			} catch (c) {}
		};
		_.z = function (a, b) {
			try {
		...
		_.Va = function (a, b) {
			var c = 0;
			a = (0, _.Ta)(String(a)).split('.');
			b = (0, _.Ta)(String(b)).split('.');
		...
		_.db =
			...
			!_.w('Edge');
		_.eb = -1 != _.qa().toLowerCase().indexOf('webkit') && !_.w('Edge');
		a: {
			var gb = '',
				hb = (function () {
					var a = _.qa();
		...
		Ga.set('error', 3);
		_.Ha = 'warn';
		for (var lb = [], mb = 0; 63 > mb; mb++) lb[mb] = 0;
		_.nb = [].concat(128, lb);
		var Ma =
		...
		_.qb = /^(?:(?:https?|mailto|ftp):|[^:/?#]*(?:[/?#]|$))/i;
		_.ob = {};
		_.rb = new _.C('about:invalid#zClosurez', _.ob);
		var vb;
		_.sb = {};
		_.tb = function (a, b) {
			this.h = b === _.sb ? a : '';
		...
		_.ub = function (a) {
			return a instanceof _.tb && a.constructor === _.tb ? a.h : 'type_error:SafeHtml';
		};
		vb = new _.tb((_.v.trustedTypes && _.v.trustedTypes.emptyHTML) || '', _.sb);
		_.wb = (function (a) {
			var b = !1,
				c;
			return function () {
		...
		_.yb.prototype.o = !1;
		_.yb.prototype.jc = function () {
			return this.o;
		};
		_.yb.prototype.U = function () {
			this.o || ((this.o = !0), this.Y());
		};
		_.yb.prototype.Y = function () {
		...
		var Cb = function (a, b) {
			...
			if (a) {
				...
				d
					...
					: ((this.j = _.eb || void 0 !== a.offsetX ? a.offsetX : a.layerX),
					  (this.l = _.eb || void 0 !== a.offsetY ? a.offsetY : a.layerY),
				...
				this.pointerType =
					'string' === typeof a.pointerType ? a.pointerType : Bb[a.pointerType] || '';
				this.state = a.state;
				this.V = a;
				a.defaultPrevented && Cb.na.preventDefault.call(this);
			}
		};
		_.Sa(Cb, _.zb);
		var Bb = { 2: 'touch', 3: 'pen', 4: 'mouse' };
		Cb.prototype.stopPropagation = function () {
			Cb.na.stopPropagation.call(this);
			this.V.stopPropagation ? this.V.stopPropagation() : (this.V.cancelBubble = !0);
		};
		Cb.prototype.preventDefault = function () {
			Cb.na.preventDefault.call(this);
			var a = this.V;
			a.preventDefault ? a.preventDefault() : (a.returnValue = !1);
		};
		Cb.prototype.Sc = function () {
			return this.V;
		};
		var Db;
		...
		Jb.prototype.add = function (a, b, c, d, e) {
			...
			-1 < g
				? ((b = a[g]), c || (b.Ya = !1))
				: ((b = new Gb(b, this.src, f, !!d, e)), (b.Ya = c), a.push(b));
			return b;
		};
		Lb = function (a, b) {
			var c = b.type;
		...
		Jb.prototype.La = function (a, b, c, d) {
			a = this.h[a.toString()];
			var e = -1;
			a && (e = Kb(a, b, c, d));
			return -1 < e ? a[e] : null;
		...
		_.D = function (a, b, c, d, e) {
			...
			c = _.Rb(c);
			return _.Eb(a) ? a.J(b, c, _.Ra(d) ? !!d.capture : !!d, e) : Sb(a, b, c, !1, d, e);
		};
		Sb = function (a, b, c, d, e, f) {
			...
			if (a.addEventListener)
				Ab || (e = g), void 0 === e && (e = !1), a.addEventListener(b.toString(), d, e);
		...
		_.Qb = function (a, b, c, d, e) {
			...
			c = _.Rb(c);
			return _.Eb(a) ? a.Eb(b, c, _.Ra(d) ? !!d.capture : !!d, e) : Sb(a, b, c, !0, d, e);
		};
		Xb = function (a, b, c, d, e) {
			if (Array.isArray(b)) for (var f = 0; f < b.length; f++) Xb(a, b[f], c, d, e);
			else
				(d = _.Ra(d) ? !!d.capture : !!d),
					(c = _.Rb(c)),
					_.Eb(a) ? a.oa(b, c, d, e) : a && (a = _.Tb(a)) && (b = a.La(b, c, d, e)) && _.Yb(b);
		};
		_.Yb = function (a) {
			if ('number' === typeof a || !a || a.Ma) return !1;
			var b = a.src;
			if (_.Eb(b)) return Lb(b.Z, a);
			var c = a.type,
				d = a.proxy;
			...
			Pb--;
			(c = _.Tb(b)) ? (Lb(c, a), 0 == c.i && ((c.src = null), (b[Nb] = null))) : Hb(a);
			return !0;
		};
		Vb = function (a) {
		...
		_.l.dispatchEvent = function (a) {
			...
			a.i || ((g = a.h = c), (e = ac(g, d, !0, a) && e), a.i || (e = ac(g, d, !1, a) && e));
			if (b) for (f = 0; !a.i && f < b.length; f++) (g = a.h = b[f]), (e = ac(g, d, !1, a) && e);
			return e;
		};
		_.l.Y = function () {
			_.$b.na.Y.call(this);
		...
		_.l.oa = function (a, b, c, d) {
			...
			if (a in e.h) {
				...
				b = Kb(f, b, c, d);
				-1 < b &&
					(Hb(f[b]), Array.prototype.splice.call(f, b, 1), 0 == f.length && (delete e.h[a], e.i--));
			}
		};
		...
		_.$b.prototype.La = function (a, b, c, d) {
		...
		var oc, qc, yc, rc, tc, sc, wc, uc, pc, zc, Ec;
		_.jc = function (a) {
		...
		_.mc = function (a, b, c) {
			b instanceof pc ? ((a.l = b), vc(a.l, a.m)) : (c || (b = qc(b, wc)), (a.l = new pc(b, a.m)));
		};
		_.xc = function (a) {
		...
		_.l.da = function (a) {
			zc(this);
			var b = [];
			if ('string' === typeof a) Ec(this, a) && (b = b.concat(this.h.get(Cc(this, a))));
			else {
		...
		_.l.set = function (a, b) {
			...
			this.j = null;
			a = Cc(this, a);
			Ec(this, a) && (this.i -= this.h.get(a).length);
			this.h.set(a, [b]);
			this.i += 1;
			return this;
		};
		...
		var Ac = function (a, b, c) {
			_.Dc(a, b);
			0 < c.length && ((a.j = null), a.h.set(Cc(a, b), _.Fa(c)), (a.i += c.length));
		};
	...
	try {
		...
		_.Oc.prototype.set = function (a, b, c) {
			var d = !1;
			if ('object' === typeof c) {
				var e = c.Hb;
				d = c.Ib || !1;
		...
		_.Oc.prototype.get = function (a, b) {
		...
		_.Oc.prototype.Ka = function () {
			return Pc(this).keys;
		};
		_.Oc.prototype.da = function () {
			return Pc(this).values;
		};
		Pc = function (a) {
			a = (a.h.cookie || '').split(';');
		...
		_.Qc = new _.Oc('undefined' == typeof document ? null : document);
	} catch (e) {
		_._DumpException(e);
	}
	try {
...
*/
		...
		_.$c = function (a, b) {
			Yc ? a[Yc] && (a[Yc] &= ~b) : void 0 !== a.ca && (a.ca &= ~b);
		};
		_.G = function (a) {
			var b;
			Yc ? (b = a[Yc]) : (b = a.ca);
		...
		hd = function (a) {
			var b = a.length;
			(b = b ? a[b - 1] : void 0) && gd(b) ? (b.g = 1) : ((b = {}), a.push(((b.g = 1), b)));
		};
		_.jd = function (a, b, c) {
			var d = !1;
			if (null != a && 'object' === typeof a && !(d = Array.isArray(a)) && a.cb === _.id) return a;
			if (d) return new b(a);
			if (c) return new b();
		};
		ld = function (a, b) {
		...
		_.od = function (a) {
			switch (typeof a) {
				...
				case 'object':
					if (a)
						if (Array.isArray(a)) {
							if (0 !== (_.G(a) & 128)) return (a = Array.prototype.slice.call(a)), hd(a), a;
						} else {
							if (_.Xc(a)) return md(a);
							if (a instanceof _.nd) {
								var b = a.P;
								return null == b ? '' : 'string' === typeof b ? b : (a.P = md(b));
							}
						}
			}
			return a;
		...
		qd = function (a, b, c, d) {
			if (null != a) {
				if (Array.isArray(a)) a = _.pd(a, b, c, void 0 !== d);
				else if (gd(a)) {
					var e = {},
						f;
					for (f in a) e[f] = qd(a[f], b, c, d);
					a = e;
				} else a = b(a, d);
				return a;
			}
		...
		_.pd = function (a, b, c, d) {
			...
			for (var f = 0; f < a.length; f++) a[f] = qd(a[f], b, c, d);
			c(e, a);
			return a;
		};
		rd = function (a) {
			return a.cb === _.id ? a.toJSON() : _.od(a);
		};
		sd = function (a, b) {
			a & 128 && hd(b);
		};
		...
		zd = function (a, b, c) {
			c = void 0 === c ? fd : c;
			if (null != a) {
				if (Wc && a instanceof Uint8Array)
					return a.length ? new _.nd(new Uint8Array(a), _.xd) : _.yd();
				if (Array.isArray(a)) {
					var d = _.G(a);
					if (d & 2) return a;
					if (b && !(d & 32) && (d & 16 || 0 === d)) return _.ad(a, d | 2), a;
					a = _.pd(a, zd, c, !0);
					b = _.G(a);
					b & 4 && b & 2 && Object.freeze(a);
					return a;
				}
				return a.cb === _.id ? vd(a) : a;
			}
		};
		vd = function (a) {
			if (_.cd(a.I)) return a;
			a = Ad(a, !0);
			_.Zc(a.I, 2);
			return a;
		};
		Ad = function (a, b) {
			...
			0 !== (_.G(c) & 128) && hd(d);
			b = b || a.fa() ? fd : _.ed;
			d = ld(a.constructor, d);
			a.za && (d.za = a.za.slice());
			e = !!(_.G(c) & 16);
			for (var f = 0; f < c.length; f++) {
				var g = c[f];
				if (f === c.length - 1 && gd(g))
					for (var h in g) {
						var k = +h;
						if (Number.isNaN(k)) td(d)[k] = g[k];
						else {
							var m = g[h],
								n = a.O && a.O[k];
							n ? _.Bd(d, k, wd(n), !0) : _.H(d, k, zd(m, e, b), !0);
						}
					}
				else
					(k = f - a.va), (m = a.O && a.O[k]) ? _.Bd(d, k, wd(m), !1) : _.H(d, k, zd(g, e, b), !1);
			}
			return d;
		};
		Cd = function (a, b) {
		...
		_.Md = function (a) {
			return { id: _.F(a, 1), ic: _.F(a, 4), displayName: _.F(a, 3), la: _.F(a, 6) };
		};
		Nd = function (a, b, c) {
		...
		_.Pd = function (a, b, c) {
			Function.prototype.bind && -1 != Function.prototype.bind.toString().indexOf('native code')
				? (_.Pd = Nd)
				: (_.Pd = Od);
			return _.Pd.apply(null, arguments);
		};
		Qd = function (a) {
		...
		Rd = function (a) {
			var b;
			(b = a.h) || ((b = {}), Qd(a) && ((b[0] = !0), (b[1] = !0)), (b = a.h = b));
			return b;
		};
		Sd = function (a) {
		...
		Td = function (a, b, c) {
			if ('function' === typeof a) c && (a = (0, _.Pd)(a, c));
			else if (a && 'function' == typeof a.handleEvent) a = (0, _.Pd)(a.handleEvent, a);
			else throw Error('s');
		...
		Wd = [];
		Xd = function (a) {
			a.A && a.Lb && (a.A.ontimeout = null);
			a.hb && (_.v.clearTimeout(a.hb), (a.hb = null));
		};
		Yd = function (a) {
			return _.bb && 'number' === typeof a.timeout && void 0 !== a.ontimeout;
		};
		Zd = function (a) {
			a.zb || ((a.zb = !0), a.dispatchEvent('complete'), a.dispatchEvent('error'));
		};
		$d = function (a, b) {
			if (a.A) {
				Xd(a);
		...
		_.ce = function (a) {
			...
			if (!c) {
				if ((b = 0 === b))
					(a = String(a.Db).match(_.ec)[1] || null),
						!a && _.v.self && _.v.self.location && (a = _.v.self.location.protocol.slice(0, -1)),
						(b = !Ud.test(a ? a.toLowerCase() : ''));
				c = b;
			}
			return c;
		};
		de = function (a) {
			if (a.ka && 'undefined' != typeof _.Oa && (!a.jb[1] || 4 != be(a) || 2 != a.ab()))
				if (a.bb && 4 == be(a)) Td(a.pc, 0, a);
				else if ((a.dispatchEvent('readystatechange'), 4 == be(a))) {
					a.ka = !1;
					try {
						_.ce(a) ? (a.dispatchEvent('complete'), a.dispatchEvent('success')) : Zd(a);
					} finally {
						$d(a);
					}
				}
		...
		fe = function (a) {
			...
			this.jb = this.A = null;
			this.Db = '';
			this.ya = this.Ab = this.bb = this.zb = !1;
			this.ib = 0;
			this.hb = null;
			this.qc = '';
			this.Lb = this.bd = this.Nb = !1;
			this.Kb = null;
		};
		_.Sa(fe, _.$b);
		_.l = fe.prototype;
		...
		_.l.send = function (a, b, c, d) {
			if (this.A) throw Error('t`' + this.Db + '`' + a);
			b = b ? b.toUpperCase() : 'GET';
			this.Db = a;
			this.zb = !1;
			this.ka = !0;
			this.A = this.kb ? Sd(this.kb) : Sd(_.cc);
			this.jb = this.kb ? Rd(this.kb) : Rd(_.cc);
			this.A.onreadystatechange = (0, _.Pd)(this.pc, this);
			this.bd &&
				'onprogress' in this.A &&
				((this.A.onprogress = (0, _.Pd)(function (g) {
					this.oc(g, !0);
				}, this)),
				this.A.upload && (this.A.upload.onprogress = (0, _.Pd)(this.oc, this)));
			try {
			...
			'withCredentials' in this.A &&
				this.A.withCredentials !== this.Nb &&
				(this.A.withCredentials = this.Nb);
			if ('setTrustToken' in this.A && this.Kb)
				try {
					this.A.setTrustToken(this.Kb);
				} catch (g) {}
			try {
				Xd(this),
					0 < this.ib &&
						((this.Lb = Yd(this.A))
							? ((this.A.timeout = this.ib), (this.A.ontimeout = (0, _.Pd)(this.sc, this)))
							: (this.hb = Td(this.sc, this.ib, this))),
					(this.bb = !0),
					this.A.send(a),
					(this.bb = !1);
			} catch (g) {
		...
		_.l.sc = function () {
			'undefined' != typeof _.Oa && this.A && (this.dispatchEvent('timeout'), this.abort(8));
		};
		_.l.abort = function () {
			this.A &&
				this.ka &&
		...
		_.l.Y = function () {
			this.A &&
				(this.ka && ((this.ka = !1), (this.ya = !0), this.A.abort(), (this.ya = !1)), $d(this, !0));
			fe.na.Y.call(this);
		};
		_.l.pc = function () {
			this.jc() || (this.Ab || this.bb || this.ya ? de(this) : this.ad());
		};
		_.l.ad = function () {
			de(this);
		};
		_.l.oc = function (a, b) {
			this.dispatchEvent(ee(a, 'progress'));
			this.dispatchEvent(ee(a, b ? 'downloadprogress' : 'uploadprogress'));
		};
		...
		_.l.ab = function () {
			try {
				return 2 < be(this) ? this.A.status : -1;
			} catch (a) {
				return -1;
			}
		};
		...
		_.l.getAllResponseHeaders = function () {
			return this.A && 2 <= be(this) ? this.A.getAllResponseHeaders() || '' : '';
		};
		_.ge = function (a) {
			try {
		...
		te = function (a, b) {
			...
			void 0 === re && (_.v.Int32Array ? (re = new Int32Array(se)) : (re = se));
			this.reset();
		};
		_.Sa(te, pe);
		te.prototype.reset = function () {
			this.l = this.i = 0;
			this.h = _.v.Int32Array ? new Int32Array(this.m) : _.Fa(this.m);
		};
		var ue = function (a) {
		...
		te.prototype.update = function (a, b) {
			...
			if ('string' === typeof a)
				for (; c < b; )
					(this.j[d++] = a.charCodeAt(c++)), d == this.blockSize && (ue(this), (d = 0));
			else if (_.Qa(a))
				for (; c < b; ) {
					var e = a[c++];
					if (!('number' == typeof e && 0 <= e && 255 >= e && e == (e | 0))) throw Error('m');
					this.j[d++] = e;
					d == this.blockSize && (ue(this), (d = 0));
				}
			else throw Error('n');
			this.i = d;
			this.l += b;
		...
		te.prototype.digest = function () {
			var a = [],
				b = 8 * this.l;
			56 > this.i
				? this.update(_.nb, 56 - this.i)
				: this.update(_.nb, this.blockSize - (this.i - 56));
		...
		_.ye.prototype.ea = !0;
		_.ye.prototype.ba = function () {
			return this.h.toString();
		};
		_.ze = function (a) {
			return a instanceof _.ye && a.constructor === _.ye ? a.h : 'type_error:TrustedResourceUrl';
		};
		Jd = function (a) {
			if (void 0 === we) {
				var b = null;
		...
		Kd = function (a) {
			a instanceof _.tb ||
				...
				oe.test(a) &&
					...
					-1 != a.indexOf('\x00') && (a = a.replace(ne, '&#0;'))),
				(a = Jd(a)));
			return a;
		};
		Ae = function (a, b, c) {
			...
			if (b) {
				...
				for (c = d = 0; (a = e[c]); c++) {
					var g = a.className,
						h;
					if ((h = 'function' == typeof g.split)) h = 0 <= (0, _.Da)(g.split(/\s+/), b);
					h && (f[d++] = a);
				}
				f.length = d;
				return f;
		...
		_.Fe = function (a, b) {
			if (a)
				if (_.Eb(a)) a.Z && _.Mb(a.Z, b);
				else if ((a = _.Tb(a))) {
					var c = 0;
					b = b && b.toString();
					for (var d in a.h)
						if (!b || d == b)
							for (var e = a.h[d].concat(), f = 0; f < e.length; ++f) _.Yb(e[f]) && ++c;
				}
		};
		_.Ge = function (a, b) {
			_.$b.call(this);
			this.l = a || 1;
			this.j = b || _.v;
			this.s = (0, _.Pd)(this.B, this);
			this.v = Date.now();
		};
		_.Sa(_.Ge, _.$b);
		_.Ge.prototype.i = !1;
		_.Ge.prototype.h = null;
		_.Ge.prototype.B = function () {
			if (this.i) {
				...
				0 < a && a < 0.8 * this.l
					...
					: (this.h && (this.j.clearTimeout(this.h), (this.h = null)),
					  ...
					  this.i && (_.He(this), this.start()));
			}
		};
		_.Ge.prototype.start = function () {
			this.i = !0;
		...
		_.Je = 'undefined' !== typeof TextDecoder;
		var Ke, md;
		Ke = {};
		_.Le = null;
		md = function (a) {
		...
		var Wc;
		Wc = 'undefined' !== typeof Uint8Array;
		_.xd = {};
		var Ne;
		_.nd = function (a, b) {
			if (b !== _.xd) throw Error('C');
			this.P = a;
			if (null != a && 0 === a.length) throw Error('D');
		};
		_.yd = function () {
			return Ne || (Ne = new _.nd(null, _.xd));
		};
		var Yc = 'function' === typeof Symbol && 'symbol' === typeof Symbol() ? Symbol() : void 0;
		var Qe;
		_.id = {};
		Qe = [];
		_.ad(Qe, 23);
		_.Pe = Object.freeze(Qe);
		_.Re = function (a) {
			if (_.cd(a.I)) throw Error('E');
		};
		var td, Se;
		td = function (a) {
		...
		Se = function (a, b, c, d) {
			var e = _.F(a, c, d);
			b = _.jd(e, b);
			b !== e && null != b && (_.ud(a, c, b, d), _.Zc(b.I, _.G(a.I) & -33));
			return b;
		};
		...
		_.Bd = function (a, b, c, d) {
			...
			if (null != c) {
				var e = _.bd([]);
				for (var f = !1, g = 0; g < c.length; g++) (e[g] = c[g].I), (f = f || _.cd(e[g]));
				a.O || (a.O = {});
				a.O[b] = c;
				c = e;
				f ? _.$c(c, 8) : _.Zc(c, 8);
			} else a.O && (a.O[b] = void 0), (e = _.Pe);
			return _.ud(a, b, e, d);
		};
		_.N = function (a, b, c) {
			null == a && (a = _.kd);
			...
			if (c) {
				...
				for (h = 0; h < c.length; h++)
					(g = c[h]),
						g < e
							? ((g += this.va), (d = a[g]) ? Cd(d, b) : (a[g] = _.Pe))
							: (r || (r = td(this)), (d = r[g]) ? Cd(d, b) : (r[g] = _.Pe));
			}
		};
		_.N.prototype.toJSON = function () {
			var a = this.I;
			return _.Oe ? a : _.pd(a, rd, sd);
		};
		_.Ve = function (a, b) {
		...
		_.N.prototype.cb = _.id;
		_.N.prototype.toString = function () {
			return this.I.toString();
		};
		_.We = 'function' === typeof Uint8Array.prototype.slice;
		_.Xe = Symbol();
		_.Ye = Symbol();
		_.Ze = Symbol();
		_.af = function (a) {
		...
		_.df = function (a, b, c) {
			_.cf(a, { timestamp: new Date().getTime(), type: 'error', errorType: b }, c);
		};
		var ef;
		_.ff = function (a) {
			ef.h[a] = !0;
		...
		_.hf.prototype.resolve = function (a) {
			if (!this.i) throw Error('U');
			this.i(a);
			this.U();
		};
		_.hf.prototype.reject = function (a) {
			if (!this.h) throw Error('U');
			this.h(a);
			this.U();
		};
		_.hf.prototype.U = function () {
			this.h = this.i = null;
		};
		var jf;
		try {
		...
		_.Sa(of, _.Hd);
		of.prototype.wa = _.Id;
		_.pf = function (a, b) {
			return null != a && a.wa === b;
		};
		var Df, sf, Ef, rf, Ff, zf, vf, wf;
		_.qf = function (a) {
			if (null != a)
				switch (a.xb) {
					case 1:
		...
		_.Q = function (a) {
			return _.pf(a, _.Id)
				...
				: a instanceof _.tb
				? (0, _.P)(_.ub(a).toString())
				: (0, _.P)(String(String(a)).replace(rf, sf), _.qf(a));
		};
		_.P = (function (a) {
			function b(c) {
				this.Fa = c;
		...
		_.tf = function (a) {
			return a instanceof _.Hd ? !!a.Fa : !!a;
		};
		_.uf = (function (a) {
			function b(c) {
				this.Fa = c;
		...
		_.R = function (a) {
			_.pf(a, _.Id)
				? ((a = String(a.Fa).replace(vf, '').replace(wf, '&lt;')), (a = _.xf(a)))
				: (a = String(a).replace(rf, sf));
			return a;
		};
		_.Cf = function (a) {
			_.pf(a, _.mf) || _.pf(a, _.nf)
				? (a = _.yf(a))
				: a instanceof _.C
				? (a = _.yf(_.pb(a)))
				: a instanceof _.C
				? (a = _.yf(_.pb(a)))
				: a instanceof _.ye
				? (a = _.yf(_.ze(a).toString()))
				: a instanceof _.ye
				? (a = _.yf(_.ze(a).toString()))
				: ((a = String(a)), (a = zf.test(a) ? a.replace(_.Af, _.Bf) : 'about:invalid#zSoyz'));
			return a;
		};
		Df = {
			'\x00': '&#0;',
		...
		_.xf = function (a) {
			return String(a).replace(Ff, sf);
		};
		_.yf = function (a) {
			return String(a).replace(_.Af, _.Bf);
		};
		...
		_.If = function (a) {
			a = a || {};
			return (a = a.identifier) ? 'Acceso eseguito come ' + a : 'Accesso eseguito';
		};
		_.Jf = function (a) {
			return (0, _.P)(
				(a
		...
		_.ff('cancelable_auto_select');

		_.ff('enable_clearcut_logs');
	...
	try {
		...
		_.ki = function (a, b, c) {
			...
			if (b && 2 === b.Tb()) {
				...
				b && 2 === _.F(b, 10) && !_.gf('disable_personalized_button')
					? ((c = void 0 === c ? !0 : c),
					  b && _.Te(b, _.af, 8)
							? ((d = {}),
							  b &&
		...
		var oi = function (a) {
				return a instanceof ni && a.constructor === ni ? a.h : 'type_error:SafeStyle';
			},
			pi = {},
			qi = function (a, b) {
				this.h = b === pi ? a : '';
		...
		var ri = function (a) {
				return a instanceof qi && a.constructor === qi ? a.h : 'type_error:SafeStyleSheet';
			},
			si = {},
			ti = function (a, b) {
				return a && b && a.Uc && b.Uc
					...
					: a instanceof _.Hd && b instanceof _.Hd
					? a.wa != b.wa
						? !1
						: a.toString() == b.toString()
					: a == b;
			...
			wi = function (a) {
				_.pf(a, si)
					...
					: a instanceof qi
					? (a = ui(ri(a)))
					: ((a = String(a)), (a = vi.test(a) ? a : 'zSoyz'));
				return a;
			},
			xi = function () {
				return (0, _.P)(
		...
		var Di = function (a, b, c, d, e, f, g, h) {
				var k = void 0 === g ? !0 : g;
				h = void 0 === h ? !1 : h;
				g = e && 1 != e ? _.Q(zi(e)) : _.Q(zi(2));
				var m = _.P;
				k =
					'<div' +
					(k ? ' tabindex="0"' : '') +
				...
				return m(
					k +
						...
						'"' +
						(_.tf(f) && !h
							? ' style="width:' + _.R(wi(f)) + 'px; max-width:400px; min-width:min-content;"'
							: '') +
						'><div class="' +
			...
			zi = function (a) {
				...
				switch (a) {
					case 1:
						...
						break;
					case 3:
						b += 'Registrati con Google';
						break;
					case 4:
						b += 'Continua con Google';
						break;
					default:
						b += 'Accedi con Google';
				}
				...
				return (0, _.P)(
					(void 0 === a ? 0 : a)
						? '<div class="' +
								...
								xi() +
								'</div></div>'
						: '<div class="' + _.R('nsm7Bb-HzV7m-LgbsSe-Bz112c') + '">' + xi() + '</div>'
				);
			};
		var li = function (a) {
				a = a || {};
				var b = a.Ja;
				return (0, _.P)(Di(a.kc, a.size, a.theme, a.shape, a.text, a.width, void 0 === b ? !0 : b));
			},
			hi = function (a) {
				a = a || {};
				var b = a.Ja;
				return (0, _.P)(
					Di(void 0, a.size, a.theme, a.shape, a.text, void 0, void 0 === b ? !0 : b, !0)
				);
			},
			ii = function (a) {
				var b = a.Ja,
				...
				e =
					...
					'">';
				c.la
					? ((e += '<img class="' + _.R('n1UuX-DkfjY') + '" src="' + _.R(_.Cf(c.la)) + '" alt="'),
					  (h = 'Immagine del profilo di ' + _.R(b ? b : c.id)),
					  (e += _.xf(h)),
					  (e += '">'))
					: (e += _.Jf());
				h =
	...
	try {
		...
		_.Qi = function () {
			return ![_.va() && !_.Oi() && !_.Pi(), _.va() && _.za(), _.w('Edge')].some(function (a) {
				return a;
			});
		};
		_.Ri = function () {
			return (
				...
				((_.w('iPad') || _.w('iPhone')) &&
					...
					!_.ua() &&
					_.w('AppleWebKit')) ||
				(_.Ba() && 0 <= _.Va(_.Ca(), '14.4')) ||
				(_.ua() && 0 <= _.Va(_.Ni(), '100'))
			);
		};
		_.Oi = function () {
			return !_.Pi() && (_.w('iPod') || _.w('iPhone') || _.w('Android') || _.w('IEMobile'));
		};
		_.Pi = function () {
	...
	try {
		...
		_.Xk = function (a) {
			...
			a = 'object' == typeof a && a.ea ? a.ba() : String(a);
			_.qb.test(a) || (a = 'about:invalid#zClosurez');
			return new _.C(a, _.ob);
		};
		_.Zk = function (a) {
			_.yb.call(this);
			this.i = a;
		...
		_.Sa(_.Zk, _.yb);
		var $k = [];
		_.Zk.prototype.J = function (a, b, c, d) {
			Array.isArray(b) || (b && ($k[0] = b.toString()), (b = $k));
		...
		_.Zk.prototype.Eb = function (a, b, c, d) {
			return al(this, a, b, c, d);
		};
		var al = function (a, b, c, d, e, f) {
			if (Array.isArray(c)) for (var g = 0; g < c.length; g++) al(a, b, c[g], d, e, f);
			else {
		...
		_.Zk.prototype.oa = function (a, b, c, d, e) {
			if (Array.isArray(b)) for (var f = 0; f < b.length; f++) this.oa(a, b[f], c, d, e);
				...
				(c = c || this.handleEvent),
					...
					(c = _.Rb(c)),
					(d = !!d),
					(b = _.Eb(a) ? a.La(b, c, d, e) : a ? ((a = _.Tb(a)) ? a.La(b, c, d, e) : null) : null),
		...
		_.Zk.prototype.Y = function () {
			_.Zk.na.Y.call(this);
			bl(this);
		};
		_.Zk.prototype.handleEvent = function () {
			throw Error('ua');
		};
	} catch (e) {
		_._DumpException(e);
	...
	try {
		...
		_.dl = function (a) {
			var b = void 0 === b ? _.lf : b;
			a: {
				b = void 0 === b ? _.lf : b;
				for (var c = 0; c < b.length; ++c) {
					var d = b[c];
					if (d instanceof _.Ed && d.Vc(a)) {
						a = new _.C(a, _.ob);
						break a;
					}
				}
	...
	try {
			...
			e instanceof _.C ||
				...
				_.qb.test(e)
					...
					: ((e = String(e).replace(/(%0A|%0D)/g, '')),
					  (e = e.match(wl) ? new _.C(e, _.ob) : null)));
			b = b.ba();
			e = _.cl(e || _.rb);
		...
		wl = /^data:(.*);base64,[a-z0-9+\/]+=*$/i;
		yl = {};
		_.zl = function (a) {
			this.h = (yl === yl && a) || '';
		};
		_.zl.prototype.ea = !0;
		_.zl.prototype.ba = function () {
			return this.h;
		};
		_.Al = function (a, b, c) {
			_.cf(a, { timestamp: new Date().getTime(), type: 'ui_change', uiActivityType: b }, c);
		};
	} catch (e) {
		_._DumpException(e);
	}
	try {
		...
		Em = !_.bb && !_.wa();
		_.Fm = function (a) {
			if (Em && a.dataset) return a.dataset;
			var b = {};
			a = a.attributes;
			for (var c = 0; c < a.length; ++c) {
				var d = a[c];
				if (0 == d.name.lastIndexOf('data-', 0)) {
					var e = _.Cm(d.name.slice(5));
					b[e] = d.value;
				}
			}
			return b;
		...
		_.Hm = (function () {
			if (_.Ic) return Gm(/Firefox\/([0-9.]+)/);
			if (_.bb || _.cb || _.ab) return _.kb;
			if (_.Mc) {
				if (_.Ba() || _.w('Macintosh')) {
					var a = Gm(/CriOS\/([0-9.]+)/);
					if (a) return a;
				}
				return Gm(/Chrome\/([0-9.]+)/);
			}
			if (_.Nc && !_.Ba()) return Gm(/Version\/([0-9.]+)/);
			if (_.Jc || _.Kc) {
				if ((a = /Version\/(\S+).*Mobile\/(\S+)/.exec(_.qa()))) return a[1] + '.' + a[2];
			} else if (_.Lc) return (a = Gm(/Android\s+([0-9.]+)/)) ? a : Gm(/Version\/([0-9.]+)/);
			return '';
		})();
	} catch (e) {
		_._DumpException(e);
	...
	try {
		...
		_.Jm = function () {
			...
			(window.crypto || _.Fc.msCrypto).getRandomValues(a);
			return a[0].toString(16) + a[1].toString(16);
		};
		_.Lm = function (a) {
			_.Im(window.parent, a, _.Km);
		};
		_.Sm = function (a, b, c) {
			Mm
				? _.y(
				...
				? ((Om = a),
				  Pm(),
				  (a = _.Jm()),
				  _.Im(window.parent, { command: 'intermediate_iframe_ready', nonce: a }, '*'),
				  (Mm = a),
				  (Qm = b),
				  (Rm = c))
				: _.z(
		...
		Nm = function (a) {
			...
			if ('string' === typeof a) return Tm(a);
			if (Array.isArray(a)) {
				for (var b = 0; b < a.length; b++) if ('string' !== typeof a[b] || !Tm(a[b])) return !1;
				return !0;
			}
			return !1;
		};
		Tm = function (a) {
			try {
				...
				a = c;
				b = 'Cb';
				if (Um.Cb && Um.hasOwnProperty(b)) var d = Um.Cb;
				else {
					var e = new Um();
					d = Um.Cb = e;
				}
		...
		Pm = function () {
			Wm ||
				(Wm = _.D(window, 'message', function (a) {
					a = a.V;
					if (a.data) {
						var b = a.data;
							...
							window.parent && window.parent === a.source
								? Mm
									? b.nonce !== Mm
										...
										: (Xm(a.origin)
												? ((_.Km = a.origin), (_.Ym = b.parentMode || 'amp_client'), Qm && Qm())
												: (_.y('Origin verification failed. Invalid origin - ' + a.origin + '.'),
												  Rm && Rm()),
										  (Rm = Qm = Mm = void 0),
										  Wm && (_.Yb(Wm), (Wm = void 0)))
		...
		var en = function (a, b) {
			...
			for (var c in a.h) en(a.h[c], b);
		};
		cn.prototype.Ka = function (a) {
			var b = [];
			if (a) {
		...
		var fn = function (a, b, c) {
			void 0 !== a.P && c.push(b);
			for (var d in a.h) fn(a.h[d], b + d, c);
		};
		var Um = function () {
				this.h = gn(
			...
			hn = function (a, b, c, d) {
				...
				a++;
				if ('?' == e || ',' == e) return a;
				do (a = hn(a, b, c, d)), (e = c.charAt(a));
				while ('?' != e && ',' != e);
				return a + 1;
			};
		var Om, Wm, Mm, Qm, Rm;
		_.B('google.accounts.id.intermediate.verifyParentOrigin', _.Sm);
		_.B('google.accounts.id.intermediate.notifyParentResize', _.$m);
		_.B('google.accounts.id.intermediate.notifyParentClose', _.an);
		_.B('google.accounts.id.intermediate.notifyParentDone', function () {
			_.Km
				? _.Lm({ command: 'intermediate_iframe_done' })
				: _.y('Done command was not sent due to missing verified parent origin.');
		});
		_.B('google.accounts.id.intermediate.notifyParentTapOutsideMode', _.bn);
	} catch (e) {
		_._DumpException(e);
	}
	try {
		var Z = function (a, b) {
				try {
					_.Ja('info') && window.console && window.console.info && window.console.info(_.Ka(b) + a);
				} catch (c) {}
			},
			jn = function (a, b) {
				_.Ie(
			...
			qn = function () {
				var a = _.Jm().toString(),
					b = { lc: 300, path: '/', Ib: !0 },
					c;
				if ((c = _.va())) c = 0 <= _.Va(_.Hm, 80);
				c && (b.Hb = 'none');
				c = _.xc(location.origin);
				'http' === c.i && 'localhost' === c.h && ((b.Ib = void 0), (b.Hb = void 0));
				_.Qc.set('g_csrf_token', a, b);
				return a;
			},
			tn = function (a) {
				var b = void 0 === b ? 'googleidentityservice' : b;
				if (!(document.getElementById(b) && rn.get(b) && rn.get(b))) {
					var c = new _.hf(),
			...
			xn = function (a, b, c, d) {
				d = void 0 === d ? !1 : d;
				var e = _.Hc(document, 'iframe');
				e.setAttribute('src', b);
				e.id = c;
				e.title = 'Pulsante Accedi con Google';
			...
			Fn = function (a, b) {
				Bn >= (void 0 === b ? 100 : b) ||
					((b = new _.jc(Cn)),
					_.mc(b, _.Bc({ client_id: Dn, as: En, event: a.toString() })),
					_.Ie(
						b.toString(),
						void 0,
						'POST',
						...
						void 0,
						void 0,
						'https://accounts.google.com/gsi/log' !== Cn
					));
			},
			Jn = function (a) {
				var b = new (Function.prototype.bind.apply(
					Gn,
					[null, 'onetap', a, 'prompt'].concat(Hn(In.apply(1, arguments)))
				))();
				Fn(b);
			},
			Kn = function () {
				var a = new (Function.prototype.bind.apply(
					Gn,
					[null, 'onetap', void 0, 'closed'].concat(Hn(In.apply(0, arguments)))
				))();
				Fn(a);
			},
			Ln = function () {
				var a = new (Function.prototype.bind.apply(
					Gn,
					[null, 'id', void 0, 'init'].concat(Hn(In.apply(0, arguments)))
				))();
				Fn(a);
			},
			Rn = function () {
				...
				if (a) {
					...
					var c = {},
						d;
					for (d in b) b.hasOwnProperty(d) && 0 > Nn.indexOf(d.toLowerCase()) && (c[d] = b[d]);
					...
					if ((d = a.login_uri)) {
						...
						if ('https' !== b.i && 'localhost' !== b.h)
							throw (Ln('unsecuredLoginUri', d), new On('Unsecured login_uri provided.'));
						d = b.toString();
						a.login_uri = d;
					}
					d && !a.callback && (a.callback = Pn(d, c));
					'redirect' !== a.ux_mode ||
						d ||
			...
			Pn = function (a, b) {
				return function (c) {
					c && c.credential
						? ((b.credential = c.credential), (b.g_csrf_token = qn()), _.Yk(a, b))
			...
			Qn = function (a, b, c, d) {
				return function (e) {
					e && 'password' === e.type
						? ((b[c] = e.id), (b[d] = e.password), _.Yk(a, b))
			...
			Xn = function (a) {
				a = new Un(a);
				Vn.__G_ID_CLIENT__ = a;
				tn(a.Gc);
				Wn(a);
				return a;
			},
			Yn = function (a, b, c) {
				var d = Vn.__G_ID_CLIENT__;
				d || (Xn(), (d = Vn.__G_ID_CLIENT__));
				d.T(a, b, c);
			},
			$n = function (a, b, c) {
				if (a && b) {
					var d = Vn.__G_ID_CLIENT__;
					d ? Zn(d, a, b, c) : _.y('Failed to render button before calling initialize().');
				} else _.y('Failed to render button because there is no parent or options set.');
			},
			bo = function () {
				var a = Vn.__G_ID_CLIENT__;
				a || (Xn(), (a = Vn.__G_ID_CLIENT__));
				ao(a.s);
			},
			co = function () {
				var a = void 0 === a ? document.readyState : a;
				for (var b = _.Be('g_id_signout'), c = 0; c < b.length; c++) _.D(b[c], 'click', bo);
				try {
					var d = Rn();
					if (d) {
						var e = d.auto_prompt;
			...
			fo = function () {
				if (
					...
					a.content =
						'A21ylmER+Xz8wfPw5TsMTVah0yLFB/qzHtqKcwSY0jsTSEaWK+G+/AEmjP/YqZ9Rg0qkBOuyclzNzdOZU+eU5Q8AAABmeyJvcmlnaW4iOiJodHRwczovL2FjY291bnRzLmdvb2dsZS5jb206NDQzIiwiZmVhdHVyZSI6IkZlZENNIiwiZXhwaXJ5IjoxNjY5MTYxNTk5LCJpc1RoaXJkUGFydHkiOnRydWV9';
			...
			mo = function (a) {
				return (a = a && a.scope && a.scope.trim()) ? lo.apply(null, Hn(a.split(' '))) : null;
			},
			no = function (a) {
				_.Al(a, 'prompt_closed', { yd: !1 });
			},
			oo = function (a, b, c) {
				b = { Cd: b };
				void 0 !== c && (b.Dd = c);
				_.Al(a, 'prompt_resized', b);
			},
			Hn = function (a) {
		...
		var sn = function (a, b) {
				a.rel = '';
				a.href =
					b instanceof _.ye ? _.ze(b).toString() : b instanceof _.C ? _.pb(b) : _.pb(_.Xk(b));
			},
			zn = function (a, b) {
		...
		var uo = { left: 1, center: 2 },
			...
			Bo = function (a) {
				if (!a.h) {
					_.ki(a.u, a.Ea);
					var b = _.Ce('nsm7Bb-HzV7m-LgbsSe', a.u);
					b &&
						a.i &&
						pn(b, function () {
							a.i && a.i.call(a);
		...
		Ao.prototype.U = function () {
			if (!this.h) {
				var a = _.Ce('nsm7Bb-HzV7m-LgbsSe', this.u);
				a && _.Ee(a);
				this.h = !0;
		...
		var vn = function () {
			return 'Finestra di dialogo Accedi con Google';
		};
		var rn = new Map();
		var Gn = function (a, b, c) {
			var d = In.apply(3, arguments);
			this.l = a;
			this.j = b;
			this.h = c;
			this.i = d;
		...
		Gn.prototype.toString = function () {
			...
			this.i && a.push.apply(a, Hn(this.i));
			return a.join('.');
		};
		var Bn = Math.floor(100 * Math.random()),
			Cn = 'https://accounts.google.com/gsi/log',
			Dn,
			En;
		...
		var Wo = new _.zl('g_credential_picker'),
			Yo = function (a, b) {
				b = void 0 === b ? 'i_' : b;
				var c = new Uo();
				if (c.h)
				...
				this.S = null;
				b = new Uint8Array(16);
				(window.crypto || _.Fc.msCrypto).getRandomValues(b);
				this.C = btoa(String.fromCharCode.apply(String, Hn(b))).replace(/=+$/, '');
				this.G = new Map();
				this.ta = this.ua = !1;
				Xo(this, a);
			};
		...
		var Xo = function (a, b) {
			...
			if (c) Zo(a, c);
				...
				if ((c = void 0 !== b.log_level))
					(c = b.log_level), (c = void 0 === c || 0 <= (0, _.Da)(po, c));
				c && Zo(a, b.log_level);
			}
			...
			a.R = _.Dm(a.cc);
			a.Gc = b.container_css_url || 'https://accounts.google.com/gsi/style';
			a.Rc = b.revoke_url || 'https://accounts.google.com/gsi/revoke';
			c = a.R;
			var d = b.client_id,
				e = a.C;
			Cn = c ? c + '/gsi/log' : 'https://accounts.google.com/gsi/log';
			Dn = d;
			En = e;
			...
			a.dc = void 0 === b.use_fedcm_for_prompt ? void 0 : !!b.use_fedcm_for_prompt;
			c = b.state_cookie_domain;
			!c || (null != c && Ko.test(c)) || (c = void 0);
			a.s = new Eo(c, a.Kc, b.state_cookie_name);
			a.Ta(b);
			c = {};
		...
		var Wn = function (a) {
				a.Ba ||
					...
					(a.S = _.D(document, 'click', function () {
						a.ja && ap(a, !1) && (bp(a, 'tap_outside'), Kn('tapOutside'));
					})));
			},
			cp = function () {
				var a = window;
			...
			ep = function (a) {
				...
				navigator.credentials
					.get({ Xc: 'optional', signal: a.v.signal, federated: b, identity: b })
					.then(
						function (c) {
		...
		Yo.prototype.T = function (a, b, c) {
			var d = this;
			ap(this, !0) && (fp(this, 'flow_restarted'), Kn('flowRestarted'));
			this.m = a;
			this.ra = c;
			...
			this.h.client_id
				? _.gf('unsupported_browser')
					? (Z('One Tap is not supported in this User Agent.'),
					  this.l('browser_not_supported'),
					  _.df(this, 'prompt_display_failed', { cause: 'Unsupported user agent for one tap.' }),
					  Jn(a, 'browserNotSupported'))
					: Io(this.s)
					? (Z('User has closed One Tap before. Still in the cool down period.'),
					  this.l('suppressed_by_user'),
					  _.df(this, 'prompt_display_failed', { cause: 'Prompt disabled by the user.' }),
					  Jn(a, 'cooldown', (Go(this.s).prompt_suppress_level || 0).toString()))
					: cp() &&
					  (this.dc ||
							(void 0 === this.dc &&
								_.Ti.enable_fedcm.includes(this.h.client_id) &&
								_.gf('enable_fedcm_via_userid')))
					? ep(this)
					: gp(this, function (e) {
							e && _.J(e, 3)
				...
				: (_.z('Missing required parameter: client_id.'),
				  ...
				  _.df(this, 'prompt_display_failed', { cause: 'Missing required parameter: client_id.' }),
				  Jn(a, 'noClientId'));
		};
		var Zn = function (a, b, c, d) {
				...
				c.add('iframe_id', e);
				c.add('as', a.C);
				g.locale && (c.add('hl', g.locale), _.Dc(c, 'locale'));
				'warn' !== _.Ha && c.add('log_level', _.Ha);
				a.j.hint && c.add('hint', a.j.hint);
				a.j.hosted_domain && c.add('hosted_domain', a.j.hosted_domain);
				_.mc(f, c);
				g = _.Qi();
				f = xn(h, f.toString(), e, g);
				g &&
					pn(f, function (k) {
						k.preventDefault();
						k.stopPropagation();
					...
					d
						? d.xa
							...
							: ((b = {}),
							  ...
							  ap(a, !0) && (fp(a, 'flow_restarted'), Kn('buttonFlowStarted')),
							  ...
							  'redirect' === a.pa
									? (a.h.login_uri ||
									  ...
									  (a.h.g_csrf_token = qn()),
									  (b = top.location),
									  (a = _.dl(_.Wk(a.Ua, a.h))),
									  (a = _.cl(a)),
									  void 0 !== a && b.replace(a))
									: ((a.o = _.Jm()),
									  (a.h.channel_id = _.Vc(a.o)),
									  (a.h.origin = a.h.origin || location.origin),
									  _.xl(_.Wk(a.Ua, a.h), Wo) ||
											Fn(new Gn('button', 'popup', 'clicked', 'popupNotOpened'))),
			...
			ap = function (a, b) {
				...
				if (!un(a.u)) return Z('Failed to remove prompt iframe.'), !1;
				no(a);
				a.B = !0;
				a.S && (_.Yb(a.S), (a.S = null));
				return !0;
			};
		...
		var jp = function (a, b, c) {
			...
			gp = function (a, b) {
				...
				jn(c, function (d) {
					d && 'null' !== d
						? ((d = _.Ve(so, JSON.stringify(_.Dd(d)))), b(d))
						: (_.z('Check credential status returns invalid response.'),
						  a.l('unknown_reason'),
						  _.df(a, 'network', { cause: 'invalid_response' }));
				});
			},
			hp = function (a) {
				var b = a.h,
				...
				a.B = !0;
				a.bc(b);
				_.Al(a, 'prompt_displayed');
			};
		Yo.prototype.bc = function (a) {
			wn(this.u, a, 'bottom_sheet' === this.uiMode);
		};
		var ip = function (a) {
				'bottom_sheet' === a.uiMode &&
					window.setTimeout(function () {
						ap(a, !1) && (bp(a, 'auto_cancel'), Kn('autoCancel'));
					}, a.Oc);
			},
			$o = function (a, b) {
				if (b.origin === a.R && b.data && 'readyForConnect' === b.data.type)
					if ((_.x('Setup message received: ' + JSON.stringify(b.data)), b.source)) {
						...
						} else if (b.data.channelId && a.o && (a.o && _.Vc(a.o)) === b.data.channelId) {
							c = new MessageChannel();
							c.port1.onmessage = function (e) {
								a.X(e);
							};
					...
					case 'response':
						...
						if (d) {
							...
							f.prompt_suppress_level &&
								Fn(new Gn('onetap', void 0, 'resetCooldown', f.prompt_suppress_level.toString()));
						...
						b &&
							(d
								...
								: (bp(this, 'issuing_failed'), Kn('issuingFailed')),
							no(this));
						dp(a);
						break;
					case 'activity':
							...
							switch (b) {
								case 'close':
									a.data.suppress &&
										...
										Fn(
											new Gn('onetap', void 0, 'startCooldown', b.prompt_suppress_level.toString())
										),
										Ho(a, b));
									ap(this, !0) && (bp(this, 'user_cancel'), no(this), Kn('userCancel'));
									break;
								case 'resize':
									a = a.data.height;
									if (yn(a)) {
								...
								case 'cancel_auto_select':
									ao(this.s), np(this, 'auto_select_canceled');
							}
				}
		};
		var dp = function (a) {
			a.data.announcement && An(a.data.announcement);
		};
		Yo.prototype.revoke = function (a, b) {
			...
			d
				? ((a = { client_id: d, hint: a }),
				  this.C && (a.as = this.C),
				  ln(this.Rc, a, function (e) {
						if (e && 'null' !== e) {
							if (
								((e = _.Ve(to, JSON.stringify(_.Dd(e)))),
		...
		var Zo = function (a, b, c) {
			(void 0 === c ? 0 : c) && a.F && (b ? a.F.set('ll', b) : a.F.sb('ll'));
			_.Rc(b);
		};
		var Mn = {
				client_id: 'str',
		...
		var Un = function (a) {
			...
			_.gf('enable_intermediate_iframe') && (this.i = a && a.allowed_parent_origin);
			this.Ca = !1;
			this.H = !!this.i;
			this.sa = a && a.intermediate_iframe_close_callback;
			if (this.i && this.i)
				if ('string' === typeof this.i) {
					if (!mn(this.i)) throw Error('xa');
				} else if (Array.isArray(this.i))
					for (a = 0; a < this.i.length; a++)
						if ('string' !== typeof this.i[a] || !mn(this.i[a])) throw Error('ya');
		};
		_.I(Un, Yo);
		...
		var op = function (a) {
			a.Ca ||
				...
				'credentials' in navigator &&
					navigator.credentials.get({ password: !0, Xc: 'required' }).then(function (b) {
						a.K && a.K(b);
					}));
		};
		Un.prototype.T = function (a, b, c) {
			var d = this;
			this.H && this.i
				? (_.x('Verifying parent origin.'),
				  _.Sm(this.i, function () {
						_.Km
							? _.Lm({ command: 'set_ui_mode', mode: d.uiMode })
		...
		Un.prototype.X = function (a) {
			Yo.prototype.X.call(this, a);
			if (this.H && a.data && a.data.type)
				switch (a.data.type) {
					case 'response':
						a.data.response && a.data.response.credential && ((this.ac = !0), _.$m(0));
						break;
					case 'command':
						switch (a.data.command) {
							case 'close':
								this.ac ? _.$m(0) : this.sa ? (_.$m(0), this.sa()) : _.an();
								break;
							case 'resize':
								a = a.data.height;
								'number' === typeof a && !isNaN(a) && 0 < a && _.$m(a);
								break;
							case 'cancel_protect_start':
								_.bn(!1);
								break;
		...
		Un.prototype.bc = function (a) {
			wn(this.u, a, 'bottom_sheet' === this.uiMode, this.H);
		};
		Un.prototype.Sa = function (a) {
			if (this.H)
				switch (_.Ym) {
		...
		_.B('google.accounts.id.cancel', function () {
			var a = Vn.__G_ID_CLIENT__;
			a && ap(a, !0) && (fp(a, 'cancel_called'), Kn('cancel'));
		});
		_.B('google.accounts.id.disableAutoSelect', bo);
		_.B('google.accounts.id.initialize', Xn);
		_.B('google.accounts.id.prompt', Yn);
		_.B('google.accounts.id.PromptMomentNotification', Co);
		_.B('google.accounts.id.renderButton', $n);
		_.B('google.accounts.id.revoke', function (a, b) {
			var c = Vn.__G_ID_CLIENT__;
		...
		_.B('google.accounts.id.setLogLevel', function (a) {
			var b = Vn.__G_ID_CLIENT__;
			b || (Xn(), (b = Vn.__G_ID_CLIENT__));
			a = a ? a.toLowerCase() : void 0;
			void 0 === a || 0 <= (0, _.Da)(po, a)
				? Zo(b, a, !0)
				: (_.z(
		...
		var tp = new _.zl('g_auth_code_window'),
			up = function (a) {
				pp.call(this, 'code', a);
		...
		up.prototype.requestCode = function () {
			...
			'redirect' === this.pa
				? (Z('Starting redirect flow.', 'CODE_CLIENT'),
				  _.el(window.location, _.dl(io(this.o, this.s, a))))
				: (Z('Starting popup flow.', 'CODE_CLIENT'),
				  qp(this),
				  rp(this, a),
				  (this.j = _.xl(io(this.o, this.s, a), tp)),
				  !this.j && this.i
						? this.i(new jo('Failed to open popup window', 'popup_failed_to_open'))
						: sp(this));
		};
		var vp = new _.zl('g_auth_token_window'),
			wp = window,
			xp = function (a) {
		...
		xp.prototype.requestAccessToken = function (a) {
			...
			qp(this);
			rp(this, b);
			this.j = _.xl(io(this.o, this.s, b), vp);
			!this.j && this.i
				? this.i(new jo('Failed to open popup window', 'popup_failed_to_open'))
				: sp(this);
		};
		...
		_.B('google.accounts.oauth2.GoogleIdentityServicesErrorType', {
			sd: 'unknown',
			nd: 'missing_required_parameter',
			pd: 'popup_failed_to_open',
			od: 'popup_closed'
		});
		...
		_.B('google.accounts.oauth2.hasGrantedAllScopes', function (a) {
			var b = In.apply(1, arguments),
				c = mo(a);
			return c && c.length
				? (b = lo.apply(null, Hn(b))) && b.length
					? (0, _.Za)(b, function (d) {
							return 0 <= (0, _.Da)(c, d);
					  })
					: !1
		...
		_.B('google.accounts.oauth2.revoke', function (a, b) {
			...
			_.gf('enable_revoke_without_credentials')
				? kn('https://oauth2.googleapis.com/revoke', a, !1, b || function () {})
				: ln('https://oauth2.googleapis.com/revoke', a, b || function () {});
		});
	} catch (e) {
		_._DumpException(e);
	}
